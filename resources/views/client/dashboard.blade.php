                    ...
                    @forelse ($restaurants as $restaurant)
                        <div class="bg-white rounded-lg shadow-lg overflow-hidden border border-gray-200 hover:shadow-xl transition-shadow duration-300">
                            <div class="p-5">
                                ...
                                @endphp
                                <div class="mt-4">
                                    <a href="{{ $menuUrl }}" class="inline-flex items-center px-5 py-2.5 bg-blue-600 !bg-blue-600 text-white font-medium text-sm rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-300 transition-colors">
