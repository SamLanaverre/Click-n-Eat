...
<div class="container py-4">
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('restaurants.items.store', $restaurant) }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input" id="is_in_menu" name="is_in_menu" value="1" {{ old('is_in_menu') == '1' ? 'checked' : '' }}>
                                <label class="custom-control-label" for="is_in_menu">Ajouter au menu</label>
                            </div>
                            <small class="form-text text-muted">Cochez pour ajouter directement cet item au menu.</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-4">
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save mr-1"></i> Créer l'item
                    </button>
                </div>
            </form>
        </div>
